...
JID.prototype.full = function(unescape) {
    var s = this.domain
...
JID.prototype.toString = JID.prototype.full
JID.prototype.toJSON = JID.prototype.full
...
JID.prototype.getUser = function() {
    console.warn('JID.getUser: Use JID.getLocal instead')
